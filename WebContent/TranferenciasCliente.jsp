                 ...
                 <br>
                  <br>
                    ...
                    <div class="flex flex-col items-center w-full space-y-4">
                        <button type="submit" name="btnTransferencias1" class="w-60 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Cuentas propias</button>
                        <button type="submit" name="btnTransferencias2" class="w-60 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Cuentas de Terceros</button>
                    </div>
                    <br>
                     <br>                   
                       <br>
