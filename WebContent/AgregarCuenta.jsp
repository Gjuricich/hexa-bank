			...
			<div class="container mx-auto px-4 py-8">
			    <div class="w-2/3  mx-auto">
			       ...
			       <form action="ServletAdminCuentas" method="post">
					    ...
					    <button type="submit" name="btnAgregarCuenta" class="flex mx-auto mt-16 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg">Agregar</button>
					</form>
