                    ...
                    <div class="flex flex-col items-center w-full">
                        ...
                        <form class="flex flex-col items-center w-full" action="ServletTransferenciasCliente" method="post" onsubmit="return confirmacion();">
                                     ...
                                     <select id="CuentaOrigen" name="CuentaOrigen" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
						                <% if (cuentasPorCliente != null && !cuentasPorCliente.isEmpty()) { %>
						                    <% for (Cuenta cuenta : cuentasPorCliente) { %>
						                        <option value="<%= cuenta.getCbu() %>">N° <%= cuenta.getNumeroCuenta() %></option>
						                    <% } %>
						                <% } else { %>
                            ...
                            <div class="mb-4 ancho">
                                ...
                                <input type="text" required minlength="3" maxlength="150" id="detalleTransferencia" name="detalleTransferencia" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div class="mb-4 ancho">
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="importe">Importe:</label>
                                <input required type="number" max="9999999999" step="any" min="1" id="importe" name="importe" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div class="flex flex-col items-center w-full">
